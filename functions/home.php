                ...
                <div class="layui-col-lg12" style = "margin-top:1em;">
                    <div class="layui-collapse">
                      <div class="layui-colla-item">
                        <h2 class="layui-colla-title">云盘说明</h2>
                        <div class="layui-colla-content">
                            <iframe src="<?php echo './functions/readme.php?file='.$readme; ?>" width="100%" height="260px" scrolling="no" name="" frameborder = "0" align="middle"></iframe>
                        </div>
                      </div>
                    </div>
                </div>
